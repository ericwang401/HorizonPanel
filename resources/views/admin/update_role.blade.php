		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="custom-control custom-checkbox mb-3">
					<input class="custom-control-input" name="{{ $permission->name }}" id="{{ str_replace(' ', '', $permission->name) }}" type="checkbox" {{ empty($role->permissions->pluck('pivot')->where('permission_id', 'LIKE', $permission->id)->first()) !== true ? 'checked' : '' }}>
